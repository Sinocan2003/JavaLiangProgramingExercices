...
public class Q15 {
	...
	public static void main(String[] args) {
		...
		for (int taxableIncome = 50000; taxableIncome <= 60000; taxableIncome += 1000) {
			System.out.printf("%-" + cw + "d%-"+ cw + "d%-"+ cw + "d%-"+ cw + "d%-"+ cw + "d\n", 
					taxableIncome,
	...
	public static void printHeader(int cw) {
		System.out.printf("%-" + cw + "s%-"+ cw + "s%-"+ cw + "s%-"+ cw + "s%-"+ cw + "s\n", "Taxable", "Single", "Married Joint", "Married", "Head of");
		System.out.printf("%-" + cw + "s%-"+ cw + "s%-"+ cw + "s%-"+ cw + "s%-"+ cw + "s\n", "Income", "", "or Qualifying", "Separate", "a House");
		System.out.printf("%-" + cw + "s%-"+ cw + "s%-"+ cw + "s%-"+ cw + "s%-"+ cw + "s\n", "", "", "Widow(er)", "", "");
		System.out.println(String.format("%-" + (cw * 5 - cw / 2) + "s", "").replace(' ', '-'));
	}
